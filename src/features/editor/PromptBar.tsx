      ...
      <div className="promptbar promptbar--setup">
        <span className="promptbar__hint">
          {status.provider === "lm_studio"
            ...
            : "Add an Anthropic API key — or point the app at LM Studio — to describe " +
              "edits in words. A key is stored in the Keychain and every request is made " +
              "by Rust; it is never handed to the interface."}
        </span>
